//#region node_modules/.nitro/vite/services/ssr/assets/client-quiz-B2M9fWPA.js
var clientQuestions = [
	{
		key: "drain",
		...
		options: [
			{
				id: "inbox",
				label: "The inbox and replies"
			},
			{
				id: "calendar",
				label: "Scheduling and reschedules"
			},
			{
				id: "followup",
				label: "Leads going quiet after they raise a hand"
			},
			{
				id: "venture",
				label: "A new offer or setup that isn’t live yet"
			},
			{
				id: "unclear",
				label: "Everything — I can’t even name it"
			}
		]
	},
	{
		...
		options: [
			{
				id: "relieved",
				label: "Relieved — I know what I’d give them"
			},
			{
				id: "wary",
				label: "Wary — they’d need a lot of me first"
			},
			{
				id: "blank",
				label: "Blank — I wouldn’t know where to start"
			}
		]
	},
	{
		...
		options: [
			{
				id: "written",
				label: "Yes — notes, a doc, or a checklist"
			},
			{
				id: "head",
				label: "It’s in my head"
			},
			{
				id: "none",
				label: "There is no way. I just survive it."
			}
		]
	}
];
function scoreClient(a) {
	if (a.drain === "venture") return {
		id: "venture",
		title: "Stand up the first version",
		subtitle: "The leak is a new thing that doesn’t exist yet — not an inbox problem.",
		firstMove: "Pick one offer. I take the messy research and setup so a first version can actually run.",
		brief: [
	...
	if (a.drain === "followup" || a.drain === "unclear" && a.feeling === "blank") return {
		id: "funnel",
		...
		firstMove: "We map the path: page → form → pipeline → 3–5 follow-up emails. Then a person can work it.",
		brief: [
	...
	if (a.sop !== "written" || a.feeling !== "relieved") return {
		id: "system",
		...
		firstMove: "One task. Four lines. That’s the brief. The trial is those 10 hours against that card.",
		brief: [
...
//#endregion
export { scoreClient as n, clientQuestions as t };
